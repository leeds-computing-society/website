        ...
        <div className="flex flex-row justify-center grow text-white">
            <div className="flex flex-col mx-6 min-[64rem]:mx-12 min-[80rem]:mx-48 grow max-w-[96rem] border-l border-r border-dashed border-white/50">
                ...
                <div className="py-6 px-6 min-[96rem]:px-48 text-md border-t border-dashed border-white/50">
                    <p>We are looking for bright and driven graduates from all disciplines to work on exciting projects in our Analyst team.</p>
                    <p className="mt-3">You will work across a range of healthcare settings to understand requirements, and then collaborate with Software Developers to design new functionality. The role combines aspects of business analysis, systems analysis, and project management.</p>
                    <p className="mt-3">The variety of projects means that you will always have something new to learn. Your first project could be working on functionality to help a hospital manage patient flow in a busy emergency department. On the next, you could be designing and deploying an app for patients in rural communities in China.</p>
                    <p className="mt-3">Apply <Link href="https://tpp-careers.com/roles/business-analyst" className="link link-shown">here</Link>.</p>
                </div>
                <div className="flex flex-row items-center min-[48rem]:px-6 min-[96rem]:px-48  border-t border-b border-white/50 bg-brand-primary-450/50">
