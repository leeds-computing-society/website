...
export default function Page()
{
    return (
        <div className="flex flex-row justify-center grow text-white">
            <h1 className="hidden">Sponsors</h1>
